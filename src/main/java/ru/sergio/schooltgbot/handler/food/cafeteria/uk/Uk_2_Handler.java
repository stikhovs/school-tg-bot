...
@Service
public class Uk_2_Handler implements BotHandler {
    @Override
    public PartialBotApiMethod<Message> handle(Update update) {
        SendPhoto sendPhoto = new SendPhoto();
        InputStream img = getClass().getClassLoader().getResourceAsStream("img/food/uk-2.jpg");
        InputFile imgFile = new InputFile(img, "uk-2-img");
        sendPhoto.setCaption("УК-2");
