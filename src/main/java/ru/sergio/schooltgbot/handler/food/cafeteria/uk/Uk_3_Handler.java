...
@Service
public class Uk_3_Handler implements BotHandler {
    @Override
    public PartialBotApiMethod<Message> handle(Update update) {
        SendPhoto sendPhoto = new SendPhoto();
        InputStream img = getClass().getClassLoader().getResourceAsStream("img/food/uk-3.jpg");
        InputFile imgFile = new InputFile(img, "uk-3-img");
        sendPhoto.setCaption("УК-3");
