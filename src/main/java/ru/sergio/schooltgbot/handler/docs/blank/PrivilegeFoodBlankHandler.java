...
public class PrivilegeFoodBlankHandler implements BotHandler {
    ...
    public PartialBotApiMethod<Message> handle(Update update) {
        InputStream doc = getClass().getClassLoader().getResourceAsStream("img/docs/privilege_food_blank.pdf");
        InputFile file = new InputFile(doc, "Заявление на льготное питание.pdf");
